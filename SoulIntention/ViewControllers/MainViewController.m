...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:kSearchForPostsNotification object:nil userInfo:@{@"viewController" : self.currentViewController, @"text" : searchBar.text}];
    [self hideSortViewAndSearchBar];
}
